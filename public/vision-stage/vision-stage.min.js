 ...
 */
async function define( tag_name, clss, components=null){
...
export { Component, P, VisionStage, cache, classes, clearStore, clearStores, define, guard, html, icon, ifDefined, live, maybe, repeat, saveStore, svg, unsafeHTML, useSVG };
