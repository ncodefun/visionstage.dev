...
const ifDefined = directive((value) => (part) => {
    ...
    if (value === undefined && part instanceof AttributePart) {
        ...
        if (previousValue !== undefined || !previousValues$2.has(part)) {
...
export { Component, P, VisionStage, cache, classes, clearStore, clearStores, define, guard, html, icon, ifDefined, render as litRender, live, maybe, repeat, saveStore, svg, templateContent, unsafeHTML, useSVG };
