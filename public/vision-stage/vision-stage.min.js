 ...
 */
async function define( tag_name, clss, components=null, config_obj=null){
...
export { Component, P, VisionStage, cache, classes, clearStore, clearStores, config, define, guard, html, icon, ifDefined, live, maybe, repeat, saveStore, svg, unsafeHTML, useSVG };
