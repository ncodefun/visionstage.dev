...
const strIf = (str, condition) => condition ? str : '';
 ...
 */
function setConfig( config_object){
 ...
 */
async function define( tag_name, clss, components, directory=''){
	if( directory)
		DIRECTORY = directory;
...
export { Component, P, VisionStage, cache, classes, clearStore, clearStores, define, guard, html, icon, ifDefined, live, maybe, repeat, saveStore, setConfig, svg, unsafeHTML, useSVG };
